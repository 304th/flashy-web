...
} from "@/features/social/components/featured-social-sidebar/recent-announcement-social-post";
          ...
          <div className="flex flex-col gap-3 divide-y">
            {recentAnnouncements.map((socialPost) => (
              <Link href={`/social/post?id=${socialPost._id}`}>
                <RecentAnnouncementSocialPost key={socialPost._id} socialPost={socialPost} />
              </Link>
            ))}
          </div>
        </motion.div>
