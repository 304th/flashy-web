...
type TabValue = "agreements" | "favourites" | "payments" | "analytics";
...
export default function CreatorDashboardLayout({
  ...
  const handleTabChange = (tab: TabValue) => {
    router.push(`/monetise/creator-dashboard/${tab}`);
  };
  ...
  return <div className="flex flex-col max-w-page">
    <div className="flex flex-col gap-8">
      ...
      <ContentTabs tabs={creatorDashboardTabs} activeTab={activeTab} onTabChange={handleTabChange} />
    </div>
    {children}
  </div>;
}
