...
export const useUploadVideo = ({ onProgress }: { onProgress: (progress: number) => void; }) => {
  return getMutation<{ videoId: string }, unknown, UploadVideoParams>(['video', 'upload'], async (params) => {
