...
export const UserProfile = ({
  ...
  if (isLinkable) {
    return <Link
      ...
      className="hover:bg-base-300 transition rounded-md"
    >
      <BaseUserProfile
        user={user}
...
const BaseUserProfile = ({ user, withoutUsername, avatarClassname, children }: PropsWithChildren<UserProfileProps>) => (
