...
export const OptimisticLoader = ({ entity, className }: { entity: Optimistic<unknown>; className?: string; }) => {
  ...
  return <div className={`absolute inset-0 flex justify-center items-center cursor-progress z-20 ${className}`}>
