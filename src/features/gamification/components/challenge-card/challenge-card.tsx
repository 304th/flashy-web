...
export const ChallengeCard = ({
  ...
  return (
    <div
      className={cn(
        `flex items-center gap-4 p-4 rounded-lg border border-base-400
        bg-base-300/50`,
    ...
    >
      ...
      <span
        className={cn(
          "text-sm text-base-800 flex-shrink-0",
          isClaimed && "text-brand-200",
        )}
      >
      ...
      <div className="flex flex-col gap-1 flex-1 min-w-0">
        ...
        <p className="text-xs text-base-800 truncate">
