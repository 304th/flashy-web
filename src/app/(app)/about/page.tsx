  ...
  return (
    <div className="flex flex-col w-full">
      ...
      <div className="flex flex-col max-w-page mx-auto px-4 py-24 gap-24">
        ...
        <section
          className="flex flex-col items-center gap-6 py-8 border-t
            border-base-400"
        >
          <div className="text-center">
            ...
            <span
              className="text-xl md:text-2xl font-semibold bg-gradient-to-r
                from-brand-100 to-brand-200 bg-clip-text text-transparent"
            >
              Flashy Universe
            </span>
          </div>
          <div className="flex items-center gap-4">
            <a
              ...
              className="flex items-center justify-center w-10 h-10 rounded-full
                bg-base-300 hover:bg-base-400 transition-colors"
              aria-label="Twitter"
            >
              <svg
                width="18"
