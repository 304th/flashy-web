    ...
    <DialogPortal data-slot="dialog-portal">
      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          ...
          gap-4 rounded-lg border p-6 shadow-lg duration-200 max-sm:max-w-lg`,
          className,
        )}
        {...props}
      >
...
function DialogHeader({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn("flex flex-col gap-2 text-center max-sm:text-left", className)}
      {...props}
    />
  );
}
...
function DialogFooter({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        "flex flex-col-reverse gap-2 max-sm:flex-row max-sm:justify-end",
        className,
      )}
      {...props}
    />
