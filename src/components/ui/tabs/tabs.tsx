...
import { useTabObserver } from "@/components/ui/tabs/use-tab-observer";
import { mergeRefs } from "@/components/ui/tabs/merge-refs";
  ...
  return (
    ...
    >
      <TabsPrimitive.List
        ...
        className={cn(
          `group/tab-list relative flex h-12 items-center gap-6
          whitespace-nowrap`,
          className,
        )}
        {...rest}
...
export const TabMenu = {
  Root: TabMenuHorizontalRoot,
  List: TabMenuHorizontalList,
  Trigger: TabMenuHorizontalTrigger,
  Icon: TabMenuHorizontalIcon,
  ArrowIcon: TabMenuHorizontalArrowIcon,
  Content: TabMenuHorizontalContent,
};
