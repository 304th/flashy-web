...
export const Playlist = ({ playlist }: { playlist: Playlist }) => {
  return <div className="flex items-center gap-6 rounded bg-base-200 h-[150px] max-w-[690px] w-full overflow-hidden cursor-pointer transition hover:bg-base-300">
    <div
