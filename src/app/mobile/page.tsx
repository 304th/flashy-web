...
export default function MobilePage() {
  ...
  return (
    <div className="flex items-center justify-center bg-base-100 min-h-dvh w-full">
      <div className="flex flex-col items-center gap-6 p-8 text-center">
        ...
        {isIOS && (
          <a
            ...
            className="inline-flex items-center gap-2 px-4 py-2 bg-black text-white rounded-lg border border-white/20 hover:bg-gray-900 transition-colors"
          >
