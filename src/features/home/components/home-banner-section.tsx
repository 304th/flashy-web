        ...
        >
          ...
          <img
            ...
            className="absolute inset-0 w-full h-full object-cover
              transition-transform duration-300 group-hover:scale-101"
          />

          {/* Gradient Overlay */}
          <div
            className="absolute inset-0 bg-gradient-to-r from-black/60
          ...
          >
            ...
            <div className="flex flex-col gap-1">
              ...
              >
                <Button>{banner.callToActionTitle}</Button>
              </Link>
            </div>
          </div>
        </motion.div>
